<?php
/**
* Plugin Name: Bigboss Custom Post Type Widget
...
if( $pq->have_posts() ) :
?>
<ul class="bigboss-cpt-post-widget">
<?php while($pq->have_posts()) : $pq->the_post(); ?>
    <li>
    
    <div class="bigboss-cpt-image"><?php the_post_thumbnail();?></div>
    <a class="bigboss-cpt-title" href="<?php the_permalink(); ?>" rel="bookmark">
...
.bigboss-cpt-post-widget ul{}
.bigboss-cpt-post-widget li{
	float:left;
	width:100%;
	margin-top:10px;
	margin-bottom:10px;
